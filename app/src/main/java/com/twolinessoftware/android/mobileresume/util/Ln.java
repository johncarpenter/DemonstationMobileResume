package com.twolinessoftware.android.mobileresume.util;
...
import com.twolinessoftware.android.mobileresume.ResumeApplication;
...
public class Ln {
     ...
     */
    protected static BaseConfig config = new BaseConfig(ResumeApplication.getInstance());
